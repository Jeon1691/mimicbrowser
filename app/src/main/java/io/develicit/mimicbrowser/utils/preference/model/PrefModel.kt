package io.develicit.mimicbrowser.utils.preference.model

import android.provider.Settings
import io.develicit.mimicbrowser.utils.preference.SecurePreference
import io.develicit.mimicbrowser.utils.preference.security.AesCbc
import io.develicit.mimicbrowser.utils.preference.security.EncryptedPreference
import io.develicit.mimicbrowser.utils.preference.security.PrefInject
import io.develicit.mimicbrowser.utils.preference.type.*
...
abstract class PrefModel {
    ...
    private val securePref = PrefInject(EncryptedPreference(
        SecurePreference.context, AesCbc.generateKey(
            SecurePreference.context.packageName, Settings.Secure.getString(SecurePreference.context.contentResolver, Settings.Secure.ANDROID_ID).toByteArray())))
